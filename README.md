...
```javascript
sinqi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-sinqi@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sinqi = require( 'path/to/vendor/umd/fft-base-fftpack-sinqi/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-sinqi@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/fft-base-fftpack-sinqi.svg
[npm-url]: https://npmjs.org/package/@stdlib/fft-base-fftpack-sinqi

[test-image]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/fft-base-fftpack-sinqi/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/fft-base-fftpack-sinqi?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/fft-base-fftpack-sinqi.svg
[dependencies-url]: https://david-dm.org/stdlib-js/fft-base-fftpack-sinqi/main
...
[deno-url]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/tree/deno
[deno-readme]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/tree/umd
[umd-readme]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/tree/esm
[esm-readme]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/fft-base-fftpack-sinqi/main/LICENSE
